...
# This is an sqlalchemy query object telling us the location in memory of this object.
...
q1 = "your query here"
Brand.query.filter(Brand.brand_id == 'ram').one()


# Get all models with the name "Corvette" and the brand_id "che."
q2 = "your query here"
Model.query.filter(Model.name == 'Corvette', Model.brand_id == 'che').all() 
...
q8 = "your query here"
 Model.query.filter(Model.brand_id != 'for').all()
